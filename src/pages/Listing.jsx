      ...
      <div className="flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5">
        <div className=" w-full h-[200px] lg:h-[400px]">
          ...
          <div className="flex justify-start items-center space-x-4 w-[75%]">
            <p className="bg-red-800 w-full max-w-[200px] text-white text-center rounded-md p-1 font-semibold shadow-md">
              {listing.type === "rent" ? "Rent" : "Sale"}{" "}
            </p>
            <p className="bg-green-800 w-full max-w-[200px] text-white text-center rounded-md p-1 font-semibold shadow-md">
              {listing.offer && (
                <p>
